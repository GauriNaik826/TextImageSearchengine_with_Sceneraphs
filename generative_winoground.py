...
def main(_A: argparse.Namespace):
    ...
    for prompt_name in ["gpt4"]:
        ...
        print(model_name)
        benchmark_module = Winoground_generative_evaluation(model_name, model, processor, tokenizer, torch.bfloat16, DEVICE, prompt_name, _A.evaluation_type, _A.no_hard_negatives)
